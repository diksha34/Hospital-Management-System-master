...
.fas{
    font-size: 150px;
    line-height: 100px;
    background: -webkit-linear-gradient(#0007fa, #0abae1);
    -webkit-background-clip: text;
    -webkit-text-fill-color: #90000000;
}
.register{
    margin-top: 3%;
    padding: 3%;
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img style="height: 200px; width: 200px;" src="undraw_medical_care_movn.svg" alt="SVG for undraw_medical_care_movn">
                       
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            <li class="nav-item">
                                <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Patient</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="admin" aria-selected="true">Receptionist</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade active show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
