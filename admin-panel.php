...
if(isset($_POST['app-submit1']))
{
  ...
  if(date("Y-m-d",$appdate1)>=$cur_date){
    ...
    $query1=mysqli_query($con,"INSERT INTO `Bed_table`(`pid`, `fname`, `lname`, `gender`, `email`, `contact`, `Bed_type`, `Bed_charge`, `Bed_status`, `appdate`) VALUES ('$pid','$fname','$lname','$gender','$email','$contact','$Bed_type','$Bed_charge','1','$appdate')");
    if($query1)
    {
      echo "<script>alert('Your appointment successfully booked');</script>";
    }
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Co-vacx Hospital</h2></br>
...
<html lang="en">
  ...
  <style >
    ...
    .bg-primary {
    background: -webkit-linear-gradient(left, #12232E, #12232E);
}
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Book Appointment for vaccine</a>

      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Book Bed</a>
        ...
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-6" style="left: 5%">
                ...
                <div class="col-sm-8" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Book Bed</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#list-pres" onclick="clickDiv('#list-pres-list')">
                          View Bed availabilty
                        </a>
                      </p>
                    </div>
                  </div>
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
        ...
        <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-home-list"> 
          <div class="container-fluid">
          
            <div class="card-body">
              <center><h4>Booking bed</h4></center><br>
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
           
              <div class="col-md-4"><label >Bed Type:</label></div>
                <div class="col-md-8">
                    <select name="Bed_type" id="Bed_type"class="form-control" id="doctor" required="required">
                      <option value="" disabled selected>Select Type</option>
                      <option value="Covid ward">Covid ward</option> 
                ...
                <div class="col-md-4"><label >Daily Charges:</label></div>
                <div class="col-md-8">
                    <select name="Bed_charge" id="Bed_charge" class="form-control" id="doctor" required="required">
          ...
          <div class="col-md-4"><label>Booking Date</label></div>
                  <div class="col-md-8"><input type="date" class="form-control datepicker" name="appdate"></div><br><br>

                  <div class="col-md-4">
                    <input type="submit" name="app-submit1" value="Book Bed" class="btn btn-primary" id="inputbtn">
                  </div>
                  <div class="col-md-8"></div>                  
                </div>
              </form>
