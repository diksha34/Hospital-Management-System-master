...
<html lang="en">
  ...
  <body>
    ...
    animation: mover 1s infinite alternate;">
          <img src="undraw_Login_re_4vu2.svg" alt="" style=" height: 250px; width: 250px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>

         </div>

         <div class="col-md-4" style="margin-top: 5%;right: 8%;">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <div class="card-body">
              <center>
